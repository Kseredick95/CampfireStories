      ...
      <Column>
        <div className="alert bg-primary text-white">
          ...
          <Row>
            <Col size="md">
              <Row>
                <div className="col" id="banner-title">
                  <strong>New Stories???</strong>
                </div>
              </Row>
              <RowMt size="2">
                <div className="col small text-white">
                  Check to see if new stories has been created!
                </div>
              </RowMt>
            </Col>
            <div className="col-lg story-btn">
              <button className="btn btn-secondary" href="/storypage">
                Story Time!
              </button>
            </div>
          </Row>
